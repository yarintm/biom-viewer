...
if(!window.pywebview){
  ...
  window.pywebview = { api: {
    ...
    row_summary: (r, col_idxs) => post('/api/row_summary', {r, col_idxs}),
    col_summary: (c, row_idxs) => post('/api/col_summary', {c, row_idxs}),
...
API = {
    ...
    "/api/row_summary": lambda body: API_INSTANCE.row_summary(body["r"], body.get("col_idxs")),
    "/api/col_summary": lambda body: API_INSTANCE.col_summary(body["c"], body.get("row_idxs")),
